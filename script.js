...
let stopFunctions = true;

const slider = document.querySelector(`.slider`);
slider.classList.remove("helper-class");

slider.addEventListener("click", function () {
  slider.classList.toggle("helper-class");
  if (slider.classList.contains("helper-class")) {
    stopFunctions = false;
    resetCalculator();
    updateDisplay();
  } else {
